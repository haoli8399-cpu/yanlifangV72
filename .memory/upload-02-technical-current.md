...
当前代码实现主要是 V4.7。PC/H5 有大量页面原型但多数业务页使用 Mock；后端真实数据库 API 与进程内 Mock 并存；小程序仍有 Mock/TODO。V6.6 的统一 Tenant 上下文、平台演员身份和多 Tenant 合作关系尚未进入核心 Schema/API。
...
<!-- SOURCE_VALIDATION
{
  ...
  "source_hashes": {
    ...
    "codebase/package.json": "c830c9b7f14d9ed13412321eb572630fd82e83451cb01fc974e369a9bd6d4561",
