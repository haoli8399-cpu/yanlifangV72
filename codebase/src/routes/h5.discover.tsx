  ...
  return (
    <div className="mx-auto max-w-[480px] px-4 pb-24 pt-6">
      ...
      <div className="mb-6 grid grid-cols-3 gap-2">
        <Link to="/discover/actors" className="flex flex-col items-center gap-1.5 rounded-xl bg-primary/10 py-4 text-primary active:bg-primary/20">
          <Users className="h-5 w-5" />
          <span className="text-xs font-medium">找演员</span>
        </Link>
        <Link to="/discover/cases" className="flex flex-col items-center gap-1.5 rounded-xl bg-amber-500/10 py-4 text-amber-600 active:bg-amber-500/20">
          <FolderOpen className="h-5 w-5" />
          <span className="text-xs font-medium">看案例</span>
        </Link>
        <Link to="/discover/service-products" className="flex flex-col items-center gap-1.5 rounded-xl bg-violet-500/10 py-4 text-violet-600 active:bg-violet-500/20">
      ...
      <div className="mb-6">
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link to="/discover/actors" className="text-xs text-primary/70">查看全部 →</Link>
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Link to="/discover/programs" className="rounded-lg border border-border/60 bg-card/40 px-3 py-3 text-sm text-foreground active:bg-secondary/40">🎭 节目库</Link>
          <Link to="/snapshot" className="rounded-lg border border-border/60 bg-card/40 px-3 py-3 text-sm text-foreground active:bg-secondary/40">⚡ 匿名快照</Link>
          <Link to="/discover/cases" className="rounded-lg border border-border/60 bg-card/40 px-3 py-3 text-sm text-foreground active:bg-secondary/40">📂 案例库</Link>
