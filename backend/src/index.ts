...
import { engagementRoutingRoutes } from './api/v2/engagement-routing.js';
import { planRoutes } from './api/v2/plan.js';
import { quoteV2Routes } from './api/v2/quote.js';
import { collaborationRoutes } from './api/v2/collaboration.js';
import { eligibilityRoutes } from './api/v2/eligibility.js';
import { governanceRoutes } from './api/v2/governance.js';
...
await app.register(engagementRoutingRoutes);
await app.register(planRoutes);
await app.register(quoteV2Routes);
